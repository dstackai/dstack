...
from dstack._internal.hub.routers.util import error_detail, get_backend_configurator
...
async def update_backend(
    ...
    _, project = user_project
    configurator = get_backend_configurator(backend_config.backend.__root__.type)
    try:
        await run_async(configurator.configure_project, backend_config.backend.__root__)
