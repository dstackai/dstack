...
class StartCommand(BasicCommand):
    ...
    def _command(self, args: Namespace):
        ...
        os.environ["DSTACK_LOG_LEVEL"] = args.log_level
        if args.token:
            os.environ["DSTACK_ADMIN_TOKEN"] = args.token
        uvicorn_log_level = os.getenv("DSTACK_UVICORN_LOG_LEVEL", "error")
        uvicorn.run(
    ...
    def register(self):
        self._parser.add_argument(
            ...
            default=os.getenv("DSTACK_HOST", "127.0.0.1"),
        )
        self._parser.add_argument(
            "-p",
            "--port",
            ...
            default=os.getenv("DSTACK_PORT", 3000),
        )
        self._parser.add_argument(
            "-l",
            "--log-level",
            ...
            default=os.getenv("DSTACK_LOG_LEVEL", "ERROR"),
        )
