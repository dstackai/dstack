    ...
    async def test_get_metrics(
        ...
        assert metrics.metrics == [
            ...
            Metric(
                ...
                values=[64, 64] if len(ts) > 1 else [64],
            ),
            Metric(
                name="memory_total_bytes",
                timestamps=[ts[0], ts[-1]] if len(ts) > 1 else ts,
                values=[137438953472, 137438953472] if len(ts) > 1 else [137438953472],
            ),
            Metric(
            ...
            Metric(
                ...
                timestamps=[ts[0], ts[-1]] if len(ts) > 1 else ts,
                values=[34359738368, 34359738368] if len(ts) > 1 else [34359738368],
            ),
