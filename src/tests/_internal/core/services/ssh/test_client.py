...
class TestSSHClientInfo:
    def test_openbsd(self, monkeypatch: pytest.MonkeyPatch):
        monkeypatch.setattr("dstack._internal.core.services.ssh.client.IS_WINDOWS", False)
    ...
    def test_windows_msys2(self, monkeypatch: pytest.MonkeyPatch):
        monkeypatch.setattr("dstack._internal.core.services.ssh.client.IS_WINDOWS", True)
