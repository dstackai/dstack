...
from dstack import random_name, Repo, JobRefId, App, GpusRequirements, Gpu, version
from dstack.aws import logs, artifacts
...
class AwsBackend(Backend):
    ...
    def create_run(self, repo_user_name: str, repo_name: str):
        ...
        logs.create_log_group_if_not_exists(self._logs_client(), self.backend_config.bucket_name, log_group_name)
        logs.create_log_stream(self._logs_client(), log_group_name, run_name)
        return run_name
...
"""
    ...
    def poll_logs(self, repo_user_name: str, repo_name: str, run_name: str, start_time: int, attached: bool) -> \
        ...
        return logs.poll_logs(self, self._logs_client(), self.backend_config.bucket_name, repo_user_name,
