...
from dstack._internal.core.models.placement import PlacementGroup, PlacementGroupConfiguration
...
def placement_group_model_to_placement_group(
    ...
    pgc = get_placement_group_configuration(placement_group_model)
