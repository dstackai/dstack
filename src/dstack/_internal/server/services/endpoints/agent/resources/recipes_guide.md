...
- Estimate VRAM and disk before looking at offers. For a tiny model, avoid overbuying unless the cheaper path is unstable. For larger models, do not guess; use model size, precision, quantization, KV-cache, and tensor-parallel evidence.
