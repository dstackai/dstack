...
from dstack._internal.proxy.const import PROXY_PORT_ON_GATEWAY
from dstack._internal.proxy.errors import ProxyError, UnexpectedProxyError
from dstack._internal.proxy.repos.models import ACMESettings
...
def read_package_resource(file: str) -> str:
    return (
        importlib.resources.files("dstack._internal.proxy")
