...
export const CREDENTIALS_HELP = {
    ...
    body: (
        <>
            <p>
                To use Azure with <i>dstack Hub</i>, you'll need to create an Azure Active Directory app and{' '}
                specify the app credentials as the <i>Tenant ID</i>, <i>Client ID</i> and{' '}
                <i>Client secret</i> fields.
            </p>
        </>
    ),
};
...
export const STORAGE_ACCOUNT_HELP = {
    ...
    body: (
        <>
            <p>
                Select a <i>Storage account</i> to store artifacts. The <i>Storage account</i> should be in the <i>Location</i> selected.
            </p>
            <p>
                <i>dstack Hub</i> will create all the Azure resource in the resource group of the specified <i>Storage account</i>.
            </p>
        </>
    ),
};
